...
def encode_visibility(result):
    mapping = {
        ...
        "A: Easily Visible": 4,
        "A: Easily visible": 6,
        "A: Easily visible by naked eye": 3,
        "B: Visible under perfect conditions": 3,
        "B: Visible by optical aid, may be naked-eye": 2,
        "C: May need optical aid": 2,
        "C: Visible only with optical aid": 1,
        "D: Optical aid essential": 1,
        "D: Will need optical aid": 1,
        "D: Not visible": 0,
        "E: Not visible with telescope": 0,
        "F: Only photographic": 0,
        "G: Not visible": 0,
        "E: Not visible (optical only)": 0,
        "F: Not visible": 0,
        "G: Impossible": 0,
        "Legacy heuristic: Visible": 3,
        "Legacy heuristic: Marginal": 1,
        "Legacy heuristic: Not Visible": 0,
        "N/A": np.nan
    }
